...
//    Call<Student> getStudent(@Query("studentID") String studentID);
    ...
    @GET("exercices.php")
    Call<Exercice> getExercice(@Query("exerciceID") String exerciceID);
